...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($userId == NULL || $password == NULL) {
        $error = "Please enter the user ID and password";
    } else {
        // Check if ther eis already a user with the same user id.
        $command = "SELECT * FROM user WHERE user_id = '$userId' AND password = '$password'";
        ...
        if ($user) {
            ...
            $error = "Sorry we could not find a user with the given email and password.";
    }
}
?>
                                ...
                                <div class="col-lg-12">
                                    <form id="login-form" method="POST" role="form" style="display: block;">
                                        <div class="form-group">
                                            <input type="text" name="user_id" id="username" tabindex="1" class="form-control"  required="" placeholder="Username" value="">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="text-center">
                                                        <a href="register.php" tabindex="5" class="forgot-password">Do no have an account ? Register</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
